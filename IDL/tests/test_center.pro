...
t0 = systime(1)
best1 = optimize_center(slice, 1012, .25, 40, entropy=entropy1, recon=recon, air=10, center=center, histMin=-.1, histMax=.1, numThreads=12)
...
t0 = systime(1)
best2 = optimize_center(slice, 1012, .25, 40, entropy=entropy2, recon=recon, air=10, center=center, histMin=-.1, histMax=.1, numThreads=12)
